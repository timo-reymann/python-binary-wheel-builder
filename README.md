...
[![PyPI - Downloads](https://img.shields.io/pypi/dm/binary-wheel-builder)](https://pypi.org/project/binary_wheel_builder)
...
- [Prebuilt data sources](https://timo-reymann.github.io/python-binary-wheel-builder/api.wheel_sources.html) for your binaries
...
> If you want to have auto complete and validation right in the IDE, you can use the [JSON Schema](https://schema-nest.timo-reymann.de/schemas/json-schema/python-binary-wheel-builder/latest?tab=setup).
