...
LINUX_GENERIC_x86_64 = WheelPlatformIdentifier(
    platform="manylinux_2_12_x86_64.manylinux2010_x86_64"
)
LINUX_GENERIC_x84_64 = LINUX_GENERIC_x86_64  # backwards compatibility (issue #12)
LINUX_GENERIC_i386 = WheelPlatformIdentifier(
    platform="manylinux_2_12_i686.manylinux2010_i686"
)
LINUX_GENERIC_armv7a = WheelPlatformIdentifier(
    platform="manylinux_2_17_armv7l.manylinux2014_armv7l"
)
LINUX_GENERIC_aarch64 = WheelPlatformIdentifier(
    platform="manylinux_2_17_aarch64.manylinux2014_aarch64"
)
MUSLLINUX_x86_64 = WheelPlatformIdentifier(platform="musllinux_1_1_x86_64")
MUSLLINUX_aarch64 = WheelPlatformIdentifier(platform="musllinux_1_1_aarch64")
